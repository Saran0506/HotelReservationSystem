...
public class UserInterface {
    ...
    case 1:
    	...
    	if(choice==1) {
    		...
    		int add=sc.nextInt();
    		System.out.println("input must be-->Name:Age:Gender:Phonenumber:Enail:Address:Number of Adults:Number Of Children Above12:Number of Children Above5:Duration Of Stay:Resident type:Aadhar No");
    		...
    		if(result.isEmpty()) {
    			System.out.println("Data are not addes successfully");
    		}else {
