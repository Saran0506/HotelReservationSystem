...
public class UserInterface {
	...
	public static void main(String[] args) throws Exception {
		...
		do {
			...
			switch (choices) {
			case 1:
				System.out.println("Resident Registration for Both RI and NRI");
				System.out.println("**********************************************************");
...
//            System.out.println("3.Exit");
				...
				break;
			case 2:
				System.out.println("Room Manipulation Details");
				System.out.println("**************************************************************************");
				System.out.println("1.Adding New Rooms");
				System.out.println("2.Updating Room Details");
				System.out.println("3.Deleting Rooms using Floor Number");
				System.out.println("4.Deleting Rooms using Room Number");

				System.out.println("Enter the manipulation choice:");
				int choice = sc.nextInt();
				RoomService roomService = new RoomService();
				switch (choice) {
				case 1:

					List<Room> roomRecords = new ArrayList<Room>();

					List<Room> rooms = roomService.addRoomList();
					if (rooms.isEmpty()) {
						System.out.println("Room Details are not added");

					} else {
						System.out.println("Room Details are added Successfully");
					}
					break;
				case 2:
					while (true) {
						...
						String rno = sc.next();
						boolean roomNumberExists = rs.checkRoomNumber(rno);
						if (!roomNumberExists) {
							System.out.println("Room Number is Not Found.Please enter a valid room number.");

						}

						else {
							System.out.println("Enter the occupied Status");
							String occupy = sc.next();
							int count = rs.updateOccupiedStatus(rno, occupy);
							if (count == 1) {
								System.out.println("Occupancy details updated successfully");
							} else {
				...
				case 3:
					System.out.println("Enter the Room Number");
					String delRoom=sc.next();
					int a=rs.deleteRoomDetails(delRoom);
					if(a==1) {
						System.out.println("Room Details has been sucessfully deleted");
					}else {
						System.out.println("Deletion was not successfull");
					}
					break;
				}
				break;
			case 3:
				System.out.println("Booking Manipulation Details");
				...
				break;
			case 4:
				System.out.println("Manager Manipulation Details");
			...
			case 6:
				System.out.println(
						"Thank you for using Hotel Reservation System, anytime at your service; Have a great day!");
				break;
			default:
